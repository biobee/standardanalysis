...
adonis_results <- multiple_permanova(
  ...
  permutations = 999,
  longit = "Source",
  subset = "" # Write the expression to be used to subset your data
)
