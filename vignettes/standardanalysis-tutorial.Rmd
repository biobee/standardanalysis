...
This tutorial demonstrates how to use the `standardanalysis` package in R for comprehensive microbiome data analysis. `standardanalysis` provides a range of functions to streamline your workflow, from data import and preprocessing to diversity analysis, differential abundance testing, and statistical modeling.

The package offers the following capabilities:

- **Data Import and Preprocessing:**
  - `import_data`: Import microbiome data from BIOM format and mapping files.
...
- **Diversity analysis: multiple subsampling (rarefaction) workflow**
  ...
  - `make_pca`: Perform Principal Coordinates Analysis (PCoA) and generate ordination plots.
