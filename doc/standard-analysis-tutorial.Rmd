...
Some text about adding data here.
```{r, message = FALSE}
...
Remember that subsetting decreases your sample size. In case you want to transform your data (i.e. CLR), now is a good time for that. Here I use a pseudocount of 1.  
```{r}
